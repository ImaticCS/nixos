{
  programs.plasma = {
    enable = true;
    shortcuts = {
      ActivityManager.switch-to-activity-c826f595-f9cb-40af-b82d-dd51b6288dc1 = [ ];
    ...
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2026,9,3,19,15,28.762";
      dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
      dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
      kactivitymanagerdrc.activities.c826f595-f9cb-40af-b82d-dd51b6288dc1 = "Default";
      ...
      kdeglobals.General.AccentColor = "56,163,165";
      kdeglobals.General.LastUsedCustomAccentColor = "56,163,165";
      ...
      kdeglobals.KScreen.ScreenScaleFactors = "Virtual-1=1.5;Virtual-2=1.5;Virtual-3=1.5;Virtual-4=1.5;Virtual-5=1.5;Virtual-6=1.5;Virtual-7=1.5;Virtual-8=1.5;";
      kdeglobals.WM.activeBackground = "70,75,81,191";
      ...
      kwinrc.Desktops.Id_1 = "19830ba5-9322-4df8-8b0d-b7f80ccc1e04";
      kwinrc.Desktops.Number = 1;
      kwinrc.Desktops.Rows = 1;
      kwinrc.Effect-translucency.IndividualMenuConfig = true;
      kwinrc.Effect-translucency.PopupMenus = 94;
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-H-Splitter = "0,1662,0";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-Splitter = 885;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 885;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-2-Splitter = 1662;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 1707;
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0".Sizes = 1662;
